...
using System.Web.Script.Serialization;
    ...
    public partial class ApplePaySample_V2 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                //Common.CreateLogFile("ApplePaySample_V2", "Test"); ;
            }
        }
        ...
        public static object validateMerchant(string validationURL)
        {
            ...
            try
            {
                ...
                string certPwd = "ecpay"; //Merchant Identifier憑證密碼
        ...
        public static object paymentProcess(string TradeAmount, string payment)
        {
            ...
            */
            ...
            /* 將授權結果回應至Client端 */
            return new JavaScriptSerializer().DeserializeObject("test");
